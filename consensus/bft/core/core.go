...
func New(backend bft.Backend, config *bft.Config) Engine {
	...
	metrics.Register("consensus/bft/core/round", c.roundMeter)
	metrics.Register("consensus/bft/core/sequence", c.sequenceMeter)
	metrics.Register("consensus/bft/core/consensus", c.consensusTimer)
