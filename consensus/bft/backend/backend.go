...
import (
	...
	bftCore "github.com/quickchainproject/quickchain/consensus/bft/core"
...
func New(config *bft.Config, privateKey *ecdsa.PrivateKey, db qctdb.Database) consensus.BFT {
	...
	backend.core = bftCore.New(backend, backend.config)
	return backend
}
