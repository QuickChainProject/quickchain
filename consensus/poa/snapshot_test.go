...
func (r *testerChainReader) Config() *params.ChainConfig                 { return params.AllPOAProtocolChanges }
...
func TestVoting(t *testing.T) {
	...
	for i, tt := range tests {
		...
		snap, err := New(&params.POAConfig{Epoch: tt.epoch}, db).snapshot(&testerChainReader{db: db}, head.Number.Uint64(), head.Hash(), headers)
		if err != nil {
