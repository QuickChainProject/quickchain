// bootnode runs a bootstrap node for the Quickchain Discovery Protocol.
package main
...
func main() {
	var (
		...
		listenAddr  = flag.String("addr", ":36661", "listen address")
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "quickchain discovery")
		}
