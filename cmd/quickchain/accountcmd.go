...
between quickchain nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    quickchain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    quickchain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    quickchain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    quickchain account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another quickchain instance,
